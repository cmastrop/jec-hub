...
import { Flame, Mountain, Star, ArrowLeft, ArrowRight } from "lucide-react";
...
export default function YouthMinistryPage() {
  ...
  const features = [
    { icon: Flame, title: l.youthFeature1Title, desc: l.youthFeature1Desc },
    { icon: Mountain, title: l.youthFeature2Title, desc: l.youthFeature2Desc },
    { icon: Star, title: l.youthFeature3Title, desc: l.youthFeature3Desc },
  ];

  return (
    <DynamicBlocks pageSlug="ministerios/jovenes">
      <PageHero
        image="/iglesia/youth.jpg"
        label={l.youthPageLabel}
        title={l.youthPageTitle1}
        titleAccent={l.youthPageTitle2}
        allowOverlap
      />
        ...
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            <div className="bg-white rounded-xl shadow-2xl p-8 sm:p-12 text-center">
              ...
              <p className="text-[#C9A86C] font-semibold mt-4">{l.youthVerseRef}</p>
              <div className="w-16 h-0.5 bg-[#C9A86C] mx-auto my-6" />
              <p className="text-[#6B5D4D] text-base sm:text-lg leading-relaxed">{l.youthIntroDesc}</p>
            </div>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl text-[#4A3F35] mb-4" style={serif}>
              <span className="font-light">{l.youthPageTitle1} </span>
              <span className="font-bold">{l.youthPageTitle2}</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <FadeIn variant="fade-right" className="relative">
              <div className="overflow-hidden rounded-xl shadow-xl">
                <img src="/iglesia/leaders/raquel.jpg" alt={l.youthLeader} className="w-full aspect-[3/4] object-cover" />
              </div>
            </FadeIn>
            ...
            <FadeIn delay={200} variant="fade-left">
              ...
              <h2 className="text-3xl sm:text-4xl text-[#4A3F35] mb-2" style={serif}>
                <span className="font-bold text-[#C9A86C]">Raquel Guardado</span>
              </h2>
              <p className="text-[#6B5D4D] text-sm mb-6">{l.youthTitle} — Zoe Zone</p>
              <div className="w-16 h-0.5 bg-[#C9A86C] mb-8" />
              <p className="text-[#6B5D4D] text-lg leading-relaxed mb-6">{l.youthLeaderBio}</p>
              <div className="flex flex-wrap gap-4 text-sm text-[#6B5D4D] border-t border-[#E8E0D5] pt-6">
                <span>{l.youthSchedule}</span>
              </div>
            </FadeIn>
          </div>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 bg-[#4A3F35]">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            ...
            <h2 className="text-4xl font-light text-white mb-6" style={serif}>{l.youthCTATitle}</h2>
            <p className="text-xl text-white/70 mb-10 max-w-2xl mx-auto">{l.youthCTADesc}</p>
