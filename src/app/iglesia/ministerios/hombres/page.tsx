...
import { BookOpen, Users, Heart, ArrowLeft, ArrowRight } from "lucide-react";
...
export default function MensMinistryPage() {
  ...
  const features = [
    { icon: BookOpen, title: l.mensFeature1Title, desc: l.mensFeature1Desc },
    { icon: Users, title: l.mensFeature2Title, desc: l.mensFeature2Desc },
    { icon: Heart, title: l.mensFeature3Title, desc: l.mensFeature3Desc },
  ];
  ...
  return (
    <DynamicBlocks pageSlug="ministerios/hombres">
      <PageHero
        ...
        title={l.mensPageTitle1}
        titleAccent={l.mensPageTitle2}
        allowOverlap
      />
          ...
          <FadeIn>
            <div className="bg-white rounded-xl shadow-2xl p-8 sm:p-12 text-center">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-[#C9A86C] text-sm font-medium mb-6 hover:underline"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl text-[#4A3F35] mb-4" style={serif}>
              <span className="font-light">{l.mensPageTitle1} </span>
              <span className="font-bold">{l.mensPageTitle2}</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <FadeIn variant="fade-right" className="relative">
              <div className="overflow-hidden rounded-xl shadow-xl">
                <img
                  src="/iglesia/leaders/morris.jpeg"
                  alt={l.mensLeader}
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#C9A86C] text-white p-6 rounded-lg hidden md:block shadow-lg">
                ...
                <p className="text-sm mt-1">{lang === "en" ? "Years Leading" : "Años Liderando"}</p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={200} variant="fade-left">
              ...
              <h2 className="text-3xl sm:text-4xl text-[#4A3F35] mb-2" style={serif}>
                ...
                <span className="font-bold text-[#C9A86C]">Morris Velasquez</span>
              </h2>
              <p className="text-[#6B5D4D] text-sm mb-6">{l.mensTitle}</p>
