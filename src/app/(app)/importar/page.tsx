  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Sube imágenes o PDFs de chord charts para extraer canciones automáticamente con AI</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        {/* Dropbox migration */}
        <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 hover:border-[#B8960C] hover:bg-yellow-50/50 transition-all cursor-pointer">
          <div className="text-center">
            <CloudDownload className="w-12 h-12 text-[#B8960C] mx-auto mb-4" />
            <h3 className="text-lg font-semibold mb-2">Migrar desde Dropbox</h3>
            <p className="text-gray-500 text-sm mb-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h4 className="font-medium text-[#2B5EA7] mb-1">¿Cómo funciona?</h4>
        <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
          <li>Subís una imagen o PDF de un chord chart</li>
          <li>Google Gemini AI analiza la imagen y extrae los acordes y letras</li>
          <li>Revisás el resultado y lo aprobás o editás</li>
          <li>La canción se guarda en tu biblioteca en formato editable</li>
        </ol>
      </div>
    </div>
  );
